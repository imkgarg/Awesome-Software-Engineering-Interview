...
- [Data & Data Flow](https://youtu.be/YBRGp_CNzXw)
- [Databases types: SQL, NoSQL, Column, Search, Key Value](https://youtu.be/O_c7lzNbcKo)
- [Anatomy of applications and services](https://youtu.be/iuR7rzNvbxs)
- [Application Programming Interface (API)](https://youtu.be/dpcILJ8BTzU)
- [Caching | Cache Patterns | Cache Invalidation & Eviction](https://youtu.be/Ez1GK2imrsY)
- [What is a REST API? | CRUD APIs| REST vs HTTP](https://youtu.be/nUuAWn0AAiY)
- [Message Queues | Producer Consumer Model](https://youtu.be/J6CBdSCB_fY)
- [Pub Sub Messaging | Publisher Subscriber(Part 1 of 2)](https://youtu.be/EgJ7xts82Mg)
- [Pub Sub Use Cases | Publisher Subscriber (Part 2 of 2)](https://youtu.be/-vd_Ay0pvFY)
- [Performance Metrics](https://youtu.be/HrfgslRY7Ak)
- [Performance Metrics of components in a software](https://youtu.be/R72h2D3Y76g)
- [Fault and Failure in distributed systems](https://youtu.be/7vIzGmxdUvI)
- [Horizontal vs vertical scaling](https://youtu.be/G1Z7w9_vspY)
- [Database Replication | Synchronous vs Asynchronous](https://youtu.be/RIcNswROzCc)
- [CAP | Consistency, Availability and Partitioning](https://youtu.be/pSoKUfLTe8Y)
- [What is CAP Theorem? Degrees of CAP theorem, use cases](https://youtu.be/kwCFHLbIhak)
- [What is Database Sharding, Logical and Physical Shards, Dynamic vs Algorithmic Sharding](https://youtu.be/YCb-tDQWrXk)
- [Key based Sharding | Shard Key | Hash function | Advantages and disadvantages](https://youtu.be/arUpleGFdt4)
- [Range based sharding | Advantages and disadvantages | Hotspots](https://youtu.be/avepna2q9w0)
- [Directory based sharding](https://youtu.be/62adurZ_Muw)
- [Basics of consistent hashing](https://youtu.be/oKAU6LaYFhw)
- [How to solve capacity estimation problems faster?](https://youtu.be/VBw703pjC3E)
...
- [Count min sketch](https://youtu.be/kx-XDoPjoHw)
...
- [Desgin Distributed Queue](https://youtu.be/iJLL-KPqBpM)
- [Design Rate Limiter](https://youtu.be/FU4WlwfS3G0)
- [Design Distributed cache](https://youtu.be/iuqZvajTOyA)
...
- [A Design Analysis of Cloud-based Microservices Architecture at Netflix](https://medium.com/swlh/a-design-analysis-of-cloud-based-microservices-architecture-at-netflix-98836b2da45f)[Microservice Architecture pattern](https://microservices.io/patterns/microservices.html)
